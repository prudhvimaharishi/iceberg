...
public class TestGoogleCloudStorageInputStreamWrapper {
  ...
  @Test
  public void testGetPos_delegatesToUnderlyingStream() throws IOException {
  ...
  @Test
  public void testSeek_delegatesToUnderlyingStream() throws IOException {
    long newPos = 1234L;
  ...
  @Test
  public void testRead_delegatesToUnderlyingStream() throws IOException {
  ...
  @Test
  public void testReadByteArray_delegatesToUnderlyingStream() throws IOException {
  ...
  @Test
  public void testReadByteArrayWithOffset_delegatesToUnderlyingStream() throws IOException {
    byte[] b = new byte[1024];
    int off = 10;
    int len = 100;
  ...
  @Test
  public void testReadFully_delegatesToUnderlyingStream() throws IOException {
    long position = 123L;
  ...
  @Test
  public void testReadTail_delegatesToUnderlyingStream() throws IOException {
    byte[] buffer = new byte[1024];
    int offset = 10;
    int length = 100;
  ...
  @Test
  public void test_readVectored_delegatesToUnderlyingStream() throws IOException {
